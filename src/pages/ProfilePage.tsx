            ...
            <div className="space-y-3 rounded-lg border border-[var(--arena-border)] bg-[var(--arena-surface-muted)] p-3 sm:p-4">
              ...
              <div className="space-y-2 border-t border-[var(--arena-border)] pt-3">
                ...
                <label className="block space-y-1.5 text-sm font-semibold text-slate-700">
                  ...
                  <select
                    value={gear.racket_weight || ''}
                    onChange={(e) => setGear((current) => ({ ...current, racket_weight: e.target.value || null }))}
                    className="w-full rounded-md border border-slate-200 bg-white p-2.5 text-sm text-slate-800 dark:border-white/10 dark:bg-slate-900 dark:text-slate-100"
                  >
                ...
                <label className="block space-y-1.5 text-sm font-semibold text-slate-700">
                  ...
                  <select
                    value={gear.racket_balance || ''}
                    onChange={(e) => setGear((current) => ({ ...current, racket_balance: (e.target.value as never) || null }))}
                    className="w-full rounded-md border border-slate-200 bg-white p-2.5 text-sm text-slate-800 dark:border-white/10 dark:bg-slate-900 dark:text-slate-100"
                  >
                    <option value="">Not specified</option>
                    <option value="head_heavy">Head Heavy</option>
                ...
                <label className="block space-y-1.5 text-sm font-semibold text-slate-700">
                  <span>Racket Stiffness</span>
                  <select
                    value={gear.racket_stiffness || ''}
                    onChange={(e) => setGear((current) => ({ ...current, racket_stiffness: (e.target.value as never) || null }))}
                    className="w-full rounded-md border border-slate-200 bg-white p-2.5 text-sm text-slate-800 dark:border-white/10 dark:bg-slate-900 dark:text-slate-100"
                  >
                    <option value="">Not specified</option>
                    <option value="stiff">Stiff</option>
                ...
                <label className="block space-y-1.5 text-sm font-semibold text-slate-700">
                  <span>Grip Type</span>
                  <select
                    value={gear.grip_type || ''}
                    onChange={(e) => setGear((current) => ({ ...current, grip_type: (e.target.value as never) || null }))}
                    className="w-full rounded-md border border-slate-200 bg-white p-2.5 text-sm text-slate-800 dark:border-white/10 dark:bg-slate-900 dark:text-slate-100"
                  >
                    <option value="">Not specified</option>
                    <option value="towel">Towel Grip</option>
                    <option value="overgrip">Overgrip</option>
                    <option value="replacement">Replacement Grip</option>
                  </select>
                </label>
                ...
                <label className="block space-y-1.5 text-sm font-semibold text-slate-700">
                  ...
                  <select
                    value={gear.play_style || ''}
                    onChange={(e) => setGear((current) => ({ ...current, play_style: (e.target.value as never) || null }))}
                    className="w-full rounded-md border border-slate-200 bg-white p-2.5 text-sm text-slate-800 dark:border-white/10 dark:bg-slate-900 dark:text-slate-100"
                  >
                    <option value="">Not specified</option>
                ...
                <label className="block space-y-1.5 text-sm font-semibold text-slate-700">
                  ...
                  <select
                    value={gear.dominant_hand || ''}
                    onChange={(e) => setGear((current) => ({ ...current, dominant_hand: (e.target.value as never) || null }))}
                    className="w-full rounded-md border border-slate-200 bg-white p-2.5 text-sm text-slate-800 dark:border-white/10 dark:bg-slate-900 dark:text-slate-100"
                  >
                    <option value="">Not specified</option>
                ...
                <label className="block space-y-1.5 text-sm font-semibold text-slate-700">
                  <span>Player Type Preference</span>
                  <select
                    value={gear.player_type || ''}
                    onChange={(e) => setGear((current) => ({ ...current, player_type: (e.target.value as never) || null }))}
                    className="w-full rounded-md border border-slate-200 bg-white p-2.5 text-sm text-slate-800 dark:border-white/10 dark:bg-slate-900 dark:text-slate-100"
                  >
                    <option value="">Not specified</option>
